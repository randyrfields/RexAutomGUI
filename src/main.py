    ...
    while True:
        ...
        if GUI.scanRequested == True:
            ...
            for j in range(1, 8):
                ...
                print("{:02x}".format(returnValue[0]))
                print("{:02x}".format(returnValue[1]))
                print("{:02x}".format(returnValue[2]))
                print("{:02x}".format(returnValue[3]))
                print("{:02x}".format(returnValue[4]))
                GUI.drawStations()
                root.update()
